package com.edge.udf.udtf;

/*
 * UDTF is used to create multiple columns from a column, ie creating like a table from a acolumn.
 * We need to override 3 methods namely initialize(), process() and close()
 */
