...
//This UDAF Fails because it has been implemented the old way extending UDAF but here has been changed to AbstractGenericUDAFResolver

public class Mean extends AbstractGenericUDAFResolver {
	// Define Logging
	static final Log LOG = LogFactory.getLog(Mean.class.getName());
